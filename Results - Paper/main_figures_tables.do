...
*Set directory paths
global path "/Users/florianburnat/Library/CloudStorage/Dropbox-Personal/Studies & Research/Universities/UK/Warwick/MRes Business & Management/My Modules/IB9ND Causal Inference/Assessment/Essay/173961-V1/AEJ repo revised/Results - Paper"
global main_output "/Users/florianburnat/Library/CloudStorage/Dropbox-Personal/Studies & Research/Universities/UK/Warwick/MRes Business & Management/My Modules/IB9ND Causal Inference/Assessment/Essay/173961-V1/AEJ repo revised/Results - Paper/main_tables_figures"
...
foreach y in log_value_cont pos_tr_non_d {  
	foreach q in 8 12 {
		...
		*/ if quarter<=`q' & all_but_air==1, first absorb(J#I#quarter J#I#S) cluster(cluster_var)
		outreg2 using "$main_output/table5", se  excel ctitle(Sample: `y' iv all_but_air==1 q`q') addstat(F Stat, e(widstat)) nocons dec(3) nor2
		}
} 
...
qui ivreghdfe log_value_cont (ln_mfn_risk_c1_x_me=ln_mfn_risk_c1_x_me_iv) if all_but_air==1, first absorb(J#I#quarter J#I#S) cluster(cluster_var)
scalar iv_export_coeff=e(b)[1,1]

qui ivreghdfe pos_tr_non_d (ln_mfn_risk_c1_x_me=ln_mfn_risk_c1_x_me_iv) if all_but_air==1, first absorb(J#I#quarter J#I#S) cluster(cluster_var)
